...
REPO_GIT="https://github.com/MrTangLuyao/ADOFAITrainerMac.git"
...
==> 完成！正常通过 Steam 启动游戏，进任意关卡按 F3 开/关菜单。
    ...
    卸载：  curl -fsSL https://raw.githubusercontent.com/MrTangLuyao/ADOFAITrainerMac/refs/heads/main/uninstall.sh | bash
